...
function areCodeBlocksEqual(code1, code2) {
  // 解析代码为 AST
...
const code1 = "function my(a,b) {const m = a+b; return m;};";
const code2 = "function ccc(a,b) {return a +b;};";

console.log(areCodeBlocksEqual(code1, code2));
